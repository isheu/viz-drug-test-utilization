function reel_label(hcpcs_div, code) {
   var reel_index = hcpcs_div;
   var reel_hcpcs_data = hcpcs_alias.filter(function(d) { return d.hcpcs == code; })
   function gen_reel_label() {
      d3.select("div#" + reel_index).append("div")
         .style("left", function() { return column_0_x; })
         .attr("id", function() { return "bubble_" + reel_index; })
         .attr("class", "hcpcs_bubble")
         .style("margin-top", 4).style("margin-bottom", 4).style("margin-left", 4);
      d3.select("div#bubble_" + reel_index).append("h2")
         .attr("class", "bubble_title")
         .html(function() { return reel_hcpcs_data[0].hcpcs; });
      d3.select("div#bubble_" + reel_index).append("h4")
         .attr("class", "bubble_subtitle")
         .html(function() { return reel_hcpcs_data[0].hcpcs_name; });
   }
   gen_reel_label.drag_tutorial = function() {
      d3.select("div#bubble_" + reel_index)
         .append("h3").attr("class", "drag_tutorial")
         .html("Drop here")
   }
   gen_reel_label.rm_drag_tutorial = function() { d3.select("div#" + reel_index).selectAll("div#bubble_" + reel_index).selectAll(".drag_tutorial").remove() }
   gen_reel_label.change_hcpcs = function(new_code) {
      reel_hcpcs_data = hcpcs_alias.filter(function(d) { return d.hcpcs == new_code; })
      d3.select("div#bubble_" + reel_index).select("h2.bubble_title")
         .html(function() { return reel_hcpcs_data[0].hcpcs; })
      d3.select("div#bubble_" + reel_index).select("h4.bubble_subtitle")
         .html(function() { return reel_hcpcs_data[0].hcpcs_name; })
   }
...
function gen_npi_detail_table(selected_name) {
   ...
   d3.select("div#npi_detail_table").append("div").attr("id", "detail_heading").style("border-bottom", "1px solid #406584").style("margin", "0px 0px 0px 0px").style("padding","0px 0px 0px 0px");
   d3.select("div#npi_detail_table").append("div").attr("id", "detail_body").style("margin", "0px 0px 0px 0px").style("padding","0px 0px 0px 0px");
   ...
   var table_body = d3.select("div#detail_body").append("table").attr("id", "detail_body_table").attr("width", "355px").style("padding-left", "3px");
   var table_thead = table_body.append("thead")
   table_thead.append("td").attr("width", "44%").html("")
   table_thead.selectAll("td#metrics_2010").data([{"year":2010}]).enter().append("td").attr("id", "metrics_2010").attr("width", "14%").html("'10").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_thead.selectAll("td#metrics_2011").data([{"year":2011}]).enter().append("td").attr("id", "metrics_2011").attr("width", "14%").html("'11").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_thead.selectAll("td#metrics_2012").data([{"year":2012}]).enter().append("td").attr("id", "metrics_2012").attr("width", "14%").html("'12").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_thead.selectAll("td#metrics_2013").data([{"year":2013}]).enter().append("td").attr("id", "metrics_2013").attr("width", "14%").html("'13").style("border-bottom", "1px solid #406584").classed("year_labels", 1);

   var metrics_row_array = [1,2,3,4,5];
   var table_section_opiate = table_body.selectAll("tr#opiate_section").data(metrics_row_array).enter().append("tr").attr("id", "opiate_section").attr("class", function(d) { return "opiate_row_" + d;}).attr("height", "10px")
      .style("color", "#333").style("font-size", "11px");
   ...
   table_body.append("tr").attr("height", "65px");

   var table_sub1_thead = table_body.append("tr")
   table_sub1_thead.append("td").attr("width", "44%").html("")
   table_sub1_thead.selectAll("td#metrics_2010").data([{"year":2010}]).enter().append("td").attr("id", "metrics_2010").attr("width", "14%").html("'10").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_sub1_thead.selectAll("td#metrics_2011").data([{"year":2011}]).enter().append("td").attr("id", "metrics_2011").attr("width", "14%").html("'11").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_sub1_thead.selectAll("td#metrics_2012").data([{"year":2012}]).enter().append("td").attr("id", "metrics_2012").attr("width", "14%").html("'12").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_sub1_thead.selectAll("td#metrics_2013").data([{"year":2013}]).enter().append("td").attr("id", "metrics_2013").attr("width", "14%").html("'13").style("border-bottom", "1px solid #406584").classed("year_labels", 1);

   var metrics_row_array = [1,2,3,4,5];
   var table_section_chrome = table_body.selectAll("tr#chrome_section").data(metrics_row_array).enter().append("tr").attr("id", "chrome_section").attr("class", function(d) { return "chrome_row_" + d;}).attr("height", "10px")
      .style("color", "#333").style("font-size", "11px");
   ...
   table_sub2_thead.selectAll("td#metrics_2010").data([{"year":2010}]).enter().append("td").attr("id", "metrics_2010").attr("width", "14%").html("'10").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_sub2_thead.selectAll("td#metrics_2011").data([{"year":2011}]).enter().append("td").attr("id", "metrics_2011").attr("width", "14%").html("'11").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_sub2_thead.selectAll("td#metrics_2012").data([{"year":2012}]).enter().append("td").attr("id", "metrics_2012").attr("width", "14%").html("'12").style("border-bottom", "1px solid #406584").classed("year_labels", 1);
   table_sub2_thead.selectAll("td#metrics_2013").data([{"year":2013}]).enter().append("td").attr("id", "metrics_2013").attr("width", "14%").html("'13").style("border-bottom", "1px solid #406584").classed("year_labels", 1);

   var metrics_row_array = [1,2,3,4,5];
   var table_section_spec = table_body.selectAll("tr#spec_section").data(metrics_row_array).enter().append("tr").attr("id", "spec_section").attr("class", function(d) { return "spec_row_" + d;}).attr("height", "10px")
      .style("color", "#333").style("font-size", "11px");
